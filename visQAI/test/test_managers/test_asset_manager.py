...
This module validates that AssetManager correctly handles creating, reading,
...
class TestAssetManager(unittest.TestCase):
    ...
    def setUpClass(cls):
        """
        Create a temporary project directory and initialize an AssetManager
        ...
        cls.ac = AssetManager(cls.assets_dir)
