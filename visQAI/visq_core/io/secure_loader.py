...
class SignatureVerifier:
    ...
    def verify_bytes(
        self, content: bytes, expected_signature: str, identifier: str = "content"
    ) -> bool:
        """
        ...
        try:
            ...
            raise SecurityError(f"Signature verification error for {identifier}: {e}")
...
class SecurePackageLoader:
    ...
    def __init__(
        ...
        if self.enforce_signatures:
            ...
            Log.w(" WARNING: Signature verification DISABLED - use only for debugging!")
    ...
    def verify_all_sources(
        self, src_dir: Path, source_files: List[str]
    ) -> Dict[str, bool]:
        """
    ...
    def get_verification_report(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "unverified_signed_files": [
                sig for sig in self.signatures.keys() if sig not in self.verified_files
            ],
        }
...
class SecureModuleLoader:
    ...
    def __init__(self, secure_loader: SecurePackageLoader, src_dir: Path):
        """
    ...
    def load_module_secure(self, module_name: str, verify_first: bool = True) -> Any:
        """
    ...
    def load_all_modules_secure(
        self, module_names: List[str], verify_batch: bool = True
    ) -> Dict[str, Any]:
        """
