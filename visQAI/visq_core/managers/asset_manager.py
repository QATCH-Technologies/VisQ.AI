...
This module defines the AssetManager class, which manages named assets on disk
...
class AssetManager:
    ...
    Usage sketch:
        acct = AssetManager("/path/to/assets_dir")
    ...
    def __init__(self, assets_dir: Union[str, Path]) -> None:
        """
        Initialize the AssetManager with a given assets directory.
