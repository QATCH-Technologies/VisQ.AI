...
try:
    ...
    from visq_core.processors.hypothesis_testing import HypothesisTesting
    ...
    from QATCH.VisQAI.visq_core.processors.hypothesis_testing import HypothesisTesting
