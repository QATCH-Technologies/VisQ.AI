...
try:
    ...
    from visq_core.db.db import DB_PATH, Database
    from visq_core.models.formulation import Formulation
    from visq_core.view.evaluation_ui import EvaluationUI
    from visq_core.view.frame_step1 import FrameStep1
    from visq_core.view.frame_step2 import FrameStep2
    from visq_core.view.horizontal_tab_bar import HorizontalTabBar
    from visq_core.view.hypothesis_testing_ui import HypothesisTestingUI
    from visq_core.view.optimize_ui import OptimizationUI
except (ModuleNotFoundError, ImportError):
    from QATCH.common.licenseManager import LicenseManager, LicenseStatus
    ...
    from QATCH.VisQAI.visq_core.db.db import DB_PATH, Database
    from QATCH.VisQAI.visq_core.models.formulation import Formulation
    from QATCH.VisQAI.visq_core.view.evaluation_ui import EvaluationUI
    ...
    from QATCH.VisQAI.visq_core.view.horizontal_tab_bar import HorizontalTabBar
    from QATCH.VisQAI.visq_core.view.hypothesis_testing_ui import HypothesisTestingUI
    from QATCH.VisQAI.visq_core.view.optimize_ui import OptimizationUI
TRIAL_LABEL_TEXT = (
