...
try:
    from visq_core.managers.version_manager import VersionManager
    ...
    from visq_core.utils.progress_tracker import Lite_QProgressDialog
    from visq_core.view.constraints_ui import ConstraintsUI

    if TYPE_CHECKING:
        from visq_core.view.frame_step1 import FrameStep1
        from visq_core.view.main_window import VisQAIWindow

except (ModuleNotFoundError, ImportError):
    from QATCH.VisQAI.visq_core.managers.version_manager import VersionManager
    ...
    from QATCH.VisQAI.visq_core.utils.progress_tracker import Lite_QProgressDialog
    from QATCH.VisQAI.visq_core.view.constraints_ui import ConstraintsUI

    if TYPE_CHECKING:
        from QATCH.VisQAI.visq_core.view.frame_step1 import FrameStep1
