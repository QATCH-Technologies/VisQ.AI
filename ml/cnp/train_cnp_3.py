...
if __name__ == "__main__":
    ...
    data = "data/processed/augmented_formulation_data_03042026.csv"
    out = "./models/experiments/o_net_v3_03202026"
    trials = 0
    ...
    with torch.no_grad():
        for sample in samples:
            ...
            q_static = (
                sample["static"].unsqueeze(0).unsqueeze(0).repeat(1, n_shears, 1).to(device)
            )  # [1, 5, static_dim]
